...
\item[Doména] je množinou všech možných hodnot daného typu. Tedy například nějaký pomyslný typ \keyword{BOOL} by mohl mít doménu ve tvaru: $$
...
\begin{description}
\item[Skalární], které jsou opozitem hodnotových typů ze známějších jazyků a patří sem například \keyword{boolean}, \keyword{integer} nebo \keyword{string}.
