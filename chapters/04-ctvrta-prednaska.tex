...
\upabbrevref{RA} obsahuje atomické výrazy, tedy proměnné. Jedná se napří-klad o celá čísla nebo konstantní relace (TABLE DEE, TABLE DUM). Dále jsou obsaženy také složené výrazy, které jsou ustaveny rekurzivně, tedy:
\begin{enumerate}
